...
store1 = Store('Магазин 1', 'г. Москва, ул. Ленина, д. 1')
store2 = Store('Магазин 2', 'г. Москва, ул. Ленина, д. 2')
store3 = Store('Магазин 3', 'г. Москва, ул. Ленина, д. 3')

# Выбери один из созданных магазинов и протестируй все его методы: добавь товар, обнови цену, убери товар и запроси цену.
print('Магазин 1') #выводим название магазина
...
print('Магазин 1 имеет в своем ассортименте следующие товары: ')  #выводим название магазина
