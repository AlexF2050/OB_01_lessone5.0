...
# Создаём словарь items: где ключ - название товара name_product, а значение - его цена price_product. Например, {'apples': 0.5, 'bananas': 0.75}.
    ...
    def add_item(self, name_product, price_product): #создаём метод для добавления товара в ассортимент
        self.items[name_product] = price_product #Создаём новый ключ name_product и значение этого ключа price_product в словаре items
        print(f'Товар {name_product} поступил в продажу в {self.name}') #выводим сообщение о том, что товар добавлен
    ...
    def remove_item(self, name_product): #создаём метод для удаления товара из ассортимента
        if name_product in self.items: #если товар есть в словаре items
            ...
            print(f'Товар {name_product} был удален из ассортимента в {self.name}') #выводим сообщение о том, что товар удален{self.name} ') #выводим сообщение о том, что товар удален')  # выводим сообщение о том, что товар добавлен
    ...
    def update_item_price(self, name_product, new_price_product): #создаём метод для обновления цены товара и создаём новое значение new_price_product в словаре items
        if name_product in self.items: #если товар есть в словаре items
            self.items[name_product] = new_price_product #создание атрибута items с новым аргументом new_price_product
            print(f'Цена товара {name_product} была обновлена до {new_price_product} в {self.name}') #выводим сообщение о том, что цена товара была обновлена
        else:
            print(f'Товар {name_product} не найден в {self.name}') #выводим сообщение о том, что товар не найден
...
# добавляем товар в ассортимент
store1.add_item('Сыр', 100) #добавляем товар в ассортимент
store1.add_item('Яблоки', 150) #добавляем товар в ассортимент
store1.add_item('Груши', 120) #добавляем товар в ассортимент

store1.remove_item('Сыр') #удаляем товар из ассортимента

print(store1.get_item_price('Яблоки')) #выводим цену товара

store1.update_item_price('Яблоки', 200) #обновляем цену товара.add_item('Сыр', 100) #добавляем товар в ассортимент

# ____________________________ мой первый вариант, выше вариант Наставника______________________________________________
#Выбери один из созданных магазинов и протестируй все его методы: добавь товар, обнови цену, убери товар и запроси цену.
#print('"Магазин Восход"') #выводим название магазина
...
#print('Магазин "Восход" имеет в своем ассортименте следующие товары: ')  #выводим название магазина
...
#new_price_product = float(input()) #вводим новую цену товара

# выводим на экран название товара и цену товара
#print('Магазин "Восход" имеет в своем ассортименте следующие товары: ')  #выводим название магазина
#print('Название товара: ', name_product)
#print('Цена товара: ', new_price_product)
...
#Часа 4 писал этот код -  он работал нормально, но на следующем уроке я его дополнил улучшениями от Наставника.
